...
<body>
  ...
  <div class="container_w">
    <div class="container">
      		...
      		<form action="/home/reg" method="post" class="center">
				<div class="input-group input-group-lg">
				  <span class="input-group-addon" id="sizing-addon1">账号</span>
				  <input type="text"  name="account" class="form-control" placeholder="账号，可填写qq或邮箱，方便记住" aria-describedby="sizing-addon1">
				</div>
				<div class="input-group input-group-lg">
				  <span class="input-group-addon" id="sizing-addon1">昵称</span>
				  <input type="text"  name="nickname" class="form-control" placeholder="昵称" aria-describedby="sizing-addon1">
				</div>
				<div class="input-group input-group-lg">
